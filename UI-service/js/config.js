// Configuration for Planeet UI Service
...
try {
    console.log('Creating appConfig instance...');
    window.appConfig = new Config();
    console.log('appConfig created successfully:', window.appConfig);
} catch (error) {
    console.error('Failed to create appConfig:', error);
    // Fallback configuration
    window.appConfig = {
        getUsersServiceUrl: () => 'http://localhost:8080',
        getPlanningServiceUrl: () => 'http://localhost:8001',
        getVenuesServiceUrl: () => 'http://localhost:8000',
        getOutingProfileServiceUrl: () => 'http://localhost:5000'
    };
